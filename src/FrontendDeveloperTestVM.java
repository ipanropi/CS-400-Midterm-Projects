 ...
 */
public class FrontendDeveloperTestVM {

  /**
   * Test the functionality of loadfile menu.
   * This method simulates a user trying to load a file named 'songs.csv'.
  ...
  public void testLoadFile() {
    ...
    TextUITester test = new TextUITester("p1/songs.csv\n4\n");
    ...
    Assertions.assertTrue(output.startsWith("Welcome to Song Searcher!") && output.contains("songs.csv"));
  }
  ...
  public void testLoadDataIntegration(){
    ...
    // Validate the output for successful file load
    Assertions.assertTrue(output.startsWith("Welcome to Song Searcher!") &&
        output.contains("File loaded successfully! The file name is : p1/songs.csv"));
